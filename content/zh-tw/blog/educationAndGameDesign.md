...
當我們講到遊戲是如何提供玩家成就感，許多人會想到的是，完成任務獎勵金錢，或者是擊殺敵人的數值提升。遊戲透過不斷增加的數字來讓玩家感覺到進步，或許其中是有數值成長的部分在，但很可惜，遊戲設計不是那麼單純的事。

**_克服的困難_**

遊戲能真正夠提供長久成就感的原因，其實就和現實是一樣的 - 克服困難，只有克服困難所帶來的成就感，才可以提供持續的內在動力，而數值增長只是附帶的表層回報而已。

遊戲中經過設計的難度曲線，能夠讓玩家感受到挑戰性以及成就感。透過這種克服難題後的心理激勵，才能真正有效的驅使玩家前去迎接更多挑戰。

{{< pathImage "difficultyCurve.jpg" "100%" "圖片引用自 Difficulty Curves Start At Their Peak" >}}

<!-- https://www.gamasutra.com/blogs/JonBrown/20100922/88111/Difficulty_Curves_Start_At_Their_Peak.php -->

**_動機偏移_**

讓我們回到數值獎勵上。事實上，這種做法不只是效益不高，甚至還可能造成反效果。在上個章節中我們有談論到行為心理學中的內在和外在動機，內在動機是強大的，外在不是。

並且，有大量的證據顯示，當外在動機被附加到一個原本就具有內在動機的任務上時，我們反而會對這件事情失去興趣，動機偏移 Overjustification Effect 一詞就是用來描述這種情況的。

這種情形當然也會發生在遊戲設計上，而數值回報就屬於一種。如果一個遊戲提供了大量數值類的的回報，或者遊戲就是使用這種方式吸引玩家的，那麼開發著就必須不斷地創造新的目標和獎賞，否則遊戲將失去對玩家的吸引力。

{{< text/greenLine >}}
在許多現代的手機遊戲中，我們都能看到類似的影子在，但那還涉及了沉沒成本等更複雜的心理因素在，這裡先不討論
{{</ text/greenLine >}}

當然這不是說目標和獎勵一無是處，他們可以為遊玩過程添加結構和進展，但需要謹慎使用，不要讓遊戲對玩家的吸引變成數值而非遊戲本身了。尤其是有形的、可預期的以及頻繁的獎勵可能引發這種現象。
...
其實有一種方式是不會引起動機偏移的 - 驚喜獎勵，只要獎勵的形式是無形、低價值、意想不到的以及能讓玩家感覺和自己的行動有相互關聯，那麼就能對於本身存在的內在動機起到激勵作用。

假如設計師們在世界中，藏了許多影藏的寶藏，但沒有告知玩家這件事，在玩家某次不經意地發現這件事時，將會激勵玩家在後續的過程積極的探索世界的各個角落。
...
體制中的所有學生都使用相同課綱，課堂上的學生都依只能跟者教師的進度上課，更不用說還有許多種科目，在這種體制下學生們被迫依照固定的步調行進。

但事實是每個學生擅長的都不同，適合的學習步調也不同，如果教育體制要求所有學生都用同樣標準，對一部分人來說能夠接受，對另一部份來說可能就太過簡單或困難了。
...
被心理學家和遊戲設計師們稱作的 "心流" 區域，是一種最適當的的難度範圍，不會簡單到讓人覺得無療，也不會困難到讓你無法繼續。在這一範圍中，我們會對於眼前的事務相當專注，以至於感覺時間消逝的很快。

{{< pathImage "difficulty_flow.jpg" "80%" "圖片引用自 What Capcom Didn't Tell You About Resident Evil 4" >}}

所有遊戲都試圖讓玩家的感受維持在這個區域內，為此遊戲設計中常會有所謂的難度設定，讓玩家可以根據自己的需求調整難度，遊戲會根據難度設置，從調整參數到整個遊戲系統簡化都可能。

如此一來就能配合各種程度的玩家，或是讓他們先從簡單的模式熟悉後，再挑戰更高的難度。

**_動態難度設置_**

但難度選項也不是萬能的，最好的解釋方法就是 - 我要如何在對遊戲不了解的時候自己選擇難度?

如果玩家選擇了錯的難度，可能直接讓實際曲線在心流範圍外，尤其在非重複遊玩型的線性劇情遊戲，最終玩家可能在不理想的體驗下結束遊戲。

為了應對這種可能，動態難度設置 dynamic difficulty setting 被發明出來，他可以根據玩家的表現在被動中修改難度設置，好將難度曲線維持在不同玩家的心流範圍中。

惡靈古堡 Resident Evil 4 中，除了常規的難度選項以外就有隱藏的動態難度設置，如果玩家表現的良好(射擊準確、閃躲攻擊)，那麼隨者遊戲進行敵人將變得更具威脅和侵略性。反之如果玩家玩的很糟糕(不斷死亡)，那麼遊戲將變簡單，敵人反應更慢，箱子裡的財寶更加豐厚。

{{< pathImage "difficulty_dynamic.jpg" "80%" "圖片截自 What Capcom Didn't Tell You About Resident Evil 4" >}}

當然其實也有其他遊戲使用這種設置，有些硬核玩家不喜歡遊戲過於明目張膽的 "幫助" 它們，這就是動態難度精妙的地方了，如果不是事先知情，大多的玩家在過程中都不會意識到有這一系統存在。
...
強大的敵人只是為了鼓勵玩家熟悉戰鬥系統，格檔、背刺以及透過 i-frames 的效果閃躲揮砍來的巨劍；地圖中的陷阱鼓勵那些觀察細膩的玩家；強到不可思議的 Boss 讓你在最後一擊時感到如釋重負。
...
如果失去了高難度的挑戰這將會削弱每次擊殺敵人、每條發現的捷徑、每次的死裡逃生和每次擊敗 boss 帶來的成就感。

**_輔助模式_**

除此之外，有些設計者也希望在保持難度的同時，讓遊戲能被更多人接受。有些人想要體驗遊戲中的特定部分，卻被可怕的難度阻擋。

以極具爭議的高難度 Roguelite 遊戲 Darkest Dungeon 為例，即使是回合制戰鬥中也會給玩家極大壓力。其中有兩項設定相當惹人厭，第一就是敵人的屍體機制，再來則是撤退失敗的判定。

{{< pathImage "difficulty_darkestDungeon_retreatFailed.jpg" "80%" "圖片截自 Should Dark Souls Have an Easy Mode?" >}}

雖然開發著認為這兩項設定是遊戲機制中的必須，但並不是所有玩家都能夠接收。為此，輔助模式誕生了，遊戲中允許玩家修改或關閉某部分機制，以減輕玩家壓力。當然的，這些設置都會被藏在選項的深處，並且明確的說明這不是開發者的本意
...
寫到最後時，我突然思考起了一個問題。為什麼相同的情境下，我們總能夠在遊戲找到正面的例子呢? 不是設計遊戲比較簡單，也不是我刻意只找極端案例來對比，而是這背後有個更加現實差別在。

因為遊戲面對的是 "玩家市場" 他做為商業競爭的一部分，開發者們必須絞盡腦汁來讓自己的遊戲比其他進爭者更有趣、更吸引人，否則將無情的遭到市場淘汰。

但是教育體制面對的是 "未來"，糟糕的教育造成的影響不會在短時間內顯現，反而得等到未來十幾二十年才會反映在社會，就是如此才只有少數人願意主動面對改革這件事。
