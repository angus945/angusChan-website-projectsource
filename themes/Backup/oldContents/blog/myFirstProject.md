...
{{< pathImage "item_basis.jpg" "70%" >}}

消耗品 - 只能投擲一次的消耗性道具，但是可以疊加好幾個並連續投擲
{{< pathImage "item_throwing.jpg" "70%" >}}

法杖 - 兩種類型的魔法杖，相當稀有的掉落物
{{< pathImage "item_magicWand.jpg" "70%" >}}

魔法劍 - 三種擁有擁有特殊效果的的魔法劍，只能和商人購買
{{< pathImage "item_magicSword.jpg" "70%" >}}

藥水瓶 - 一次性使用的藥水瓶，扔出破裂後會有殺傷性的特殊效果
{{< pathImage "item_potions.jpg" "70%" >}}

炸彈 - 投擲後可以造成範圍殺傷的兩種炸彈，也可能炸傷玩家
{{< pathImage "item_bombs.jpg" "70%" >}}

錢幣 - 遊戲中的貨幣，可以和商人購買稀有武器或是也拿來丟
{{< pathImage "item_money.jpg" "70%" >}}

心形容器 - 遊戲中的回復手段，只要使用它來投擲敵人就行，而回復的血量就是疊加數量
{{< pathImage "item_healHeart.jpg" "70%" >}}
...
{{< pathImage "scene_title.gif" "70%" >}}

轉場 - 使用主角和南瓜頭的動畫當轉場畫面 :D
{{< pathImage "scene_translate.gif" "70%" >}}

暫停 - 遊戲中可以使用 esc 暫停，畫面右上角的問號可以觀看教學說明
{{< pathImage "scene_pause.jpg" "70%" >}}
...
{{< pathImage "audio.jpg" "70%" >}}

這裡就稍微放幾個音效展示 ~

投擲道具 - 高速飛行的風切聲

{{< pathAudio "audio_throw.mp3" >}}

丟棄道具 - 娛樂性較高的彈出音效 XD

{{< pathAudio "audio_dropItem.mp3" >}}

購買道具 - 當然是標誌性的收銀機音效 !

{{< pathAudio "audio_cashRegister.mp3" >}}

道具損毀 - 響亮的金屬碎裂聲

{{< pathAudio "feedback_itemBroken.mp3" "0.5" >}}

金屬武器擊中 - ㄎㄧㄤ

{{< pathAudio "audio_metalHit.mp3" >}}

藥水瓶碎裂 - ㄆㄧㄤ ~

{{< pathAudio "audio_glassBroken.mp3" >}}
...
{{< pathImage "feedback_attack.gif" "70%" >}}

玩家受傷 - 受傷時添加了攝影機晃動和短暫的放慢效果來提高辨識度，大量的粒子來提示敵人的攻擊方向以及沉悶的受傷音效加強衝擊感，效果挺不錯的 :D
{{< pathImage "feedback_hurt.gif" "70%" >}}

道具損毀 - 道具損毀時會播放明顯的音效及特效加強打擊感
{{< pathImage "feedback_itemborken.gif" "70%" >}}
...
{{< pathImage "real_interaction.gif" "70%" >}}
